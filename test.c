...
diagnostic_clash:
  printf("diagnostic clash: "), dump(regex, NULL, '/'), printf(" ");
  printf("against "), dump(input, NULL, '\''), printf(": ");
  printf("match_begin gave "), dump(begin, NULL, '\''), printf(", ");
  printf("match_end gave "), dump(end, NULL, '\''), printf("\n");
}
